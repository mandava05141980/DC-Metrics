...
def main():
    ...
    metric_data = []
    widget_ids = [13099, 13110, 13111]
    gateway_map = {
        13099: 'dc_iedubpdnwsacr02_gw_dub-percent',
        13110: 'dc_iedubpdnwsacr01-pri_gw_dub-percent',
        13111: 'dc_iedubpdnwsacr02-sec_gw_dub-percent',
    }
    ...
    for widget_id in widget_ids:
        ...
        for metric in response.get("data", {}).get("rows", []):
            try:
                metric_json = {
                    "measurement": "dc_link_dublin-percent",
                    "tags": {
                        "gateway": gateway
                    },
                    "fields": {
