...
def main():
    ...
    metric_data = []
    widget_ids = [13098, 13109, 13108]
    gateway_map = {
        13098: 'dc_iedubpdnwsacr02_gw_dub',
        13109: 'dc_iedubpdnwsacr01-pri_gw_dub',
        13108: 'dc_iedubpdnwsacr02-sec_gw_dub',
    }
    ...
    for widget_id in widget_ids:
        ...
        for metric in response.get("data", {}).get("rows", []):
            try:
                metric_json = {
                    "measurement": "dc_link_dublin-utilization",
                    "tags": {
                        "gateway": gateway
                    },
                    "fields": {
