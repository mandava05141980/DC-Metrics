...
def main():
    ...
    metric_data = []
    widget_ids = [12868, 12869, 13114, 13115, 13125, 13135]
    gateway_map = {
        12868: 'dc_ussclpdnwscds01_gw_scl-crl-percent',
        12869: 'dc_ussclpdnwscds02_gw_scl-crl-percent',
        13114: 'dc_gtt_gw_scl-percent',
        13115: 'dc_lumen_gw_scl-percent',
#        13118: 'dc_aws-dx-pri_gw_scl-percent',
#        13119: 'dc_aws-dx-sec_gw_scl-percent',
#        13122: 'dc_scl-seattle-lumen_gw_scl-percent',
#        13123: 'dc_scl-seattle-gtt_gw_scl-percent',
        13125: 'dc_scl-lumen-100g-pri_gw_scl-percent',
        13135: 'dc_scl-lumen-100g-sec_gw_scl-percent',
    }
    ...
    for widget_id in widget_ids:
        ...
        for metric in response.get("data", {}).get("rows", []):
            try:
                metric_json = {
                    "measurement": "dc_link_us-scl-crl-percent",
                    "tags": {
                        "gateway": gateway
                    },
                    "fields": {
