...
def main():
    ...
    metric_data = []
    widget_ids = [13076, 13078, 13100, 13102]
    gateway_map = {
        13076: 'dc_uscrlpdnwscds01_gw_crl-scl',
        13078: 'dc_uscrlpdnwscds02_gw_crl-scl',
        13100: 'dc_uscrlpbnwscpm01_gw_crl-scl',
        13102: 'dc_uscrlpbnwscpm01-sec_gw_crl-scl',
#        13104: 'dc_uscrlpdnwscds01-pri_gw_crl',
#        13105: 'dc_uscrlpdnwscds02-sec_gw_crl',
    }
    ...
    for widget_id in widget_ids:
        ...
        for metric in response.get("data", {}).get("rows", []):
            try:
                metric_json = {
                    "measurement": "dc_link_us-crl-scl-utilization",
                    "tags": {
                        "gateway": gateway
                    },
                    "fields": {
