...
def main():
    ...
    metric_data = []
    widget_ids = [13077, 13079, 13101, 13103]
    gateway_map = {
        13077: 'dc_uscrlpdnwscds01_gw_crl-scl-percent',
        13079: 'dc_uscrlpdnwscds02_gw_crl-scl-percent',
        13101: 'dc_uscrlpbnwscpm01_gw_crl-scl-percent',
        13103: 'dc_uscrlpbnwscpm01-sec_gw_crl-scl-percent',
       # 13106: 'dc_uscrlpdnwscds01-pri_gw_crl-percent',
        #13107: 'dc_uscrlpdnwscds02-sec_gw_crl-percent',
    }
    ...
    for widget_id in widget_ids:
        ...
        for metric in response.get("data", {}).get("rows", []):
            try:
                metric_json = {
                    "measurement": "dc_link_us-crl-scl-percent",
                    "tags": {
                        "gateway": gateway
                    },
                    "fields": {
