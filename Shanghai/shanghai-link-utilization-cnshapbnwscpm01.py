...
def main():
    ...
    metric_data = []
    widget_ids = [12942, 13073, 13126, 13127]
    gateway_map = {
        12942: 'dc_cnshapbnwscpm01_gw_shanghai',
        13073: 'dc_cnshapbnwscpm01_gw_shanghai-secondary',
        13126: 'dc_cnshapbnwscpm01-bw_gw_shanghai-pri',
        13127: 'dc_cnshapbnwscpm01-bw_gw_shanghai-sec',
    }
    ...
    for widget_id in widget_ids:
        ...
        for metric in response.get("data", {}).get("rows", []):
            try:
                metric_json = {
                    "measurement": "dc_link_shanghai-utilization",
                    "tags": {
                        "gateway": gateway
                    },
                    "fields": {
